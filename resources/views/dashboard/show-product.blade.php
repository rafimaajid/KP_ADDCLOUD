    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-row gap-8 py-6">
                <div class="w-1/2 bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900">
                    ...
                    <div class='mb-2'>
                        <strong>Image:</strong>
                        <p><img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" style="width: 90%;max-width: 400px"></p>
                    </div>
                </div>
                <div class="w-1/2 bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900">
